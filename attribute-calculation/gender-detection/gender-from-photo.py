...
images ="/home/amiangshu/Works/scratch/GenderClassification/TestUsers/single/"

results ="file,gender,score\n"

for filename in os.listdir(images):
    print(filename)
    iPath = os.path.join(images, filename)
    (gender, confidence_score)= predict_gender(iPath)
    print(filename +":"+ gender+" ( "+str(confidence_score)+" )")
    results =results +filename+ "," +str(gender)+","+str(confidence_score)+"\n"

f = open("gender_resolve.csv", "w")
f.write(results)
f.close()